...
@ApplicationScoped
public class CustomerOfferTransformer extends CloudEventPrinter {

    private static final String EXTERNAL_SOURCE = "external";

    private static final JsonFormat.TypeRegistry TYPE_REGISTRY = TypeRegistry.newBuilder().build();

    public CustomerOfferTransformer() {
        super(TYPE_REGISTRY);
    }
