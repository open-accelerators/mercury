...
/**
 * BQCollateralRetrieveOutputModelCustomerOfferProcedureInstanceRecord1CustomerOfferProcessingTask
 */

@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2021-11-19T11:10:08.827631+01:00[Europe/Madrid]")
public class BQCollateralRetrieveOutputModelCustomerOfferProcedureInstanceRecord1CustomerOfferProcessingTask {
  ...
  public BQCollateralRetrieveOutputModelCustomerOfferProcedureInstanceRecord1CustomerOfferProcessingTask customerOfferProcessingTaskType(String customerOfferProcessingTaskType) {
  ...
  **/
  ...
  public BQCollateralRetrieveOutputModelCustomerOfferProcedureInstanceRecord1CustomerOfferProcessingTask employeeBusinessUnitReference(String employeeBusinessUnitReference) {
  ...
  **/
  @Schema(example = "783804", description = "`status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Employees involved in completing the offer task ")
  ...
  public BQCollateralRetrieveOutputModelCustomerOfferProcedureInstanceRecord1CustomerOfferProcessingTask customerOfferProcessingTaskWorkProducts(String customerOfferProcessingTaskWorkProducts) {
  ...
  **/
  ...
  public BQCollateralRetrieveOutputModelCustomerOfferProcedureInstanceRecord1CustomerOfferProcessingTask customerOfferProcessingTaskResult(String customerOfferProcessingTaskResult) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BQCollateralRetrieveOutputModelCustomerOfferProcedureInstanceRecord1CustomerOfferProcessingTask bqCollateralRetrieveOutputModelCustomerOfferProcedureInstanceRecord1CustomerOfferProcessingTask = (BQCollateralRetrieveOutputModelCustomerOfferProcedureInstanceRecord1CustomerOfferProcessingTask) o;
    return Objects.equals(this.customerOfferProcessingTaskType, bqCollateralRetrieveOutputModelCustomerOfferProcedureInstanceRecord1CustomerOfferProcessingTask.customerOfferProcessingTaskType) &&
        Objects.equals(this.employeeBusinessUnitReference, bqCollateralRetrieveOutputModelCustomerOfferProcedureInstanceRecord1CustomerOfferProcessingTask.employeeBusinessUnitReference) &&
        Objects.equals(this.customerOfferProcessingTaskWorkProducts, bqCollateralRetrieveOutputModelCustomerOfferProcedureInstanceRecord1CustomerOfferProcessingTask.customerOfferProcessingTaskWorkProducts) &&
        Objects.equals(this.customerOfferProcessingTaskResult, bqCollateralRetrieveOutputModelCustomerOfferProcedureInstanceRecord1CustomerOfferProcessingTask.customerOfferProcessingTaskResult);
  }
  ...
  public String toString() {
    ...
    sb.append("class BQCollateralRetrieveOutputModelCustomerOfferProcedureInstanceRecord1CustomerOfferProcessingTask {\n");
