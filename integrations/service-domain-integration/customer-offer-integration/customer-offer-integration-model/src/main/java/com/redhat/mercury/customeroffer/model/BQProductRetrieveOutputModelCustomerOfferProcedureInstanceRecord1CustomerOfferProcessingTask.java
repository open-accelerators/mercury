...
/**
 * BQProductRetrieveOutputModelCustomerOfferProcedureInstanceRecord1CustomerOfferProcessingTask
 */

@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2021-11-19T11:10:08.827631+01:00[Europe/Madrid]")
public class BQProductRetrieveOutputModelCustomerOfferProcedureInstanceRecord1CustomerOfferProcessingTask {
  ...
  public BQProductRetrieveOutputModelCustomerOfferProcedureInstanceRecord1CustomerOfferProcessingTask customerOfferProcessingTaskType(String customerOfferProcessingTaskType) {
  ...
  **/
  ...
  public BQProductRetrieveOutputModelCustomerOfferProcedureInstanceRecord1CustomerOfferProcessingTask employeeBusinessUnitReference(String employeeBusinessUnitReference) {
  ...
  **/
  @Schema(example = "785480", description = "`status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Employees involved in completing the offer task ")
  ...
  public BQProductRetrieveOutputModelCustomerOfferProcedureInstanceRecord1CustomerOfferProcessingTask customerOfferProcessingTaskWorkProducts(String customerOfferProcessingTaskWorkProducts) {
  ...
  **/
  ...
  public BQProductRetrieveOutputModelCustomerOfferProcedureInstanceRecord1CustomerOfferProcessingTask customerOfferProcessingTaskResult(String customerOfferProcessingTaskResult) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BQProductRetrieveOutputModelCustomerOfferProcedureInstanceRecord1CustomerOfferProcessingTask bqProductRetrieveOutputModelCustomerOfferProcedureInstanceRecord1CustomerOfferProcessingTask = (BQProductRetrieveOutputModelCustomerOfferProcedureInstanceRecord1CustomerOfferProcessingTask) o;
    return Objects.equals(this.customerOfferProcessingTaskType, bqProductRetrieveOutputModelCustomerOfferProcedureInstanceRecord1CustomerOfferProcessingTask.customerOfferProcessingTaskType) &&
        Objects.equals(this.employeeBusinessUnitReference, bqProductRetrieveOutputModelCustomerOfferProcedureInstanceRecord1CustomerOfferProcessingTask.employeeBusinessUnitReference) &&
        Objects.equals(this.customerOfferProcessingTaskWorkProducts, bqProductRetrieveOutputModelCustomerOfferProcedureInstanceRecord1CustomerOfferProcessingTask.customerOfferProcessingTaskWorkProducts) &&
        Objects.equals(this.customerOfferProcessingTaskResult, bqProductRetrieveOutputModelCustomerOfferProcedureInstanceRecord1CustomerOfferProcessingTask.customerOfferProcessingTaskResult);
  }
  ...
  public String toString() {
    ...
    sb.append("class BQProductRetrieveOutputModelCustomerOfferProcedureInstanceRecord1CustomerOfferProcessingTask {\n");
