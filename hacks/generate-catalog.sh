...
opm init mercury-operator --default-channel=preview --description=./README.md --icon=./docs/images/mercury.png --output yaml > ./deploy/olm-catalog/${API_VERSION}/mercury-catalog/operator.yaml
