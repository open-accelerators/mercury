...
import static com.redhat.mercury.customeroffer.CustomerOffer.*;
...
public class CustomerOfferInboundServiceImpl extends BaseInboundService {
    ...
    private static final Pattern CUSTOMER_OFFER_RETRIEVE_CUSTOMER_OFFER_PATH = Pattern.compile("/" + DOMAIN_NAME + "/([a-zA-Z0-9\\-]+)/customer-offer-procedure/([a-zA-Z0-9\\-]+)");
    ...
    private static final Map<Pattern, String> QUERY_PATH_MAPPINGS = Map.of(
            ...
            CUSTOMER_OFFER_RETRIEVE_CUSTOMER_OFFER_PATH, CUSTOMER_OFFER_RETRIEVE_CUSTOMER_OFFER_TYPE
            //TODO: Implement
    );
    ...
    protected Uni<Message> mapQueryMethod(CloudEvent cloudEvent) {
        switch (cloudEvent.getType()) {
            ...
            case CUSTOMER_OFFER_RETRIEVE_CUSTOMER_OFFER_TYPE:
