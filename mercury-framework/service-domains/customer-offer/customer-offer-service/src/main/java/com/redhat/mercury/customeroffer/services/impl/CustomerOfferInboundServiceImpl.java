...
public class CustomerOfferInboundServiceImpl extends BaseInboundService {
    ...
    private static final Pattern CUSTOMER_OFFER_PROCEDURE_RETRIEVE_PATH = Pattern.compile("/" + DOMAIN_NAME + "/([a-zA-Z0-9\\-]+)/customer-offer-procedure/([a-zA-Z0-9\\-]+)");
    ...
    private static final Map<Pattern, String> QUERY_PATH_MAPPINGS = Map.of(
            ...
            CUSTOMER_OFFER_PROCEDURE_RETRIEVE_PATH, CUSTOMER_OFFER_PROCEDURE_RETRIEVE_TYPE
            //TODO: Implement
    );
    ...
    private static final Map<String, Supplier<Message.Builder>> IN_TYPE_MAPPINGS = Map.of(
            CUSTOMER_OFFER_PROCEDURE_INITIATION_TYPE, () -> CustomerOfferProcedureInitiation.newBuilder(),
